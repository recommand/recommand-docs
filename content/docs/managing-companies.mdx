...
If you only want to send documents, you can simply omit the `isSmpRecipient` field or set it to `false` and then you will be able to regiter the company even if it is already registered through another Peppol provider for receiving documents.
