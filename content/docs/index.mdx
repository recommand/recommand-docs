...
<Callout type="info" title="Looking for a guide for your country?">
  What onboarding looks like depends on where your companies are registered.
  Answer three questions — one company or many, which country, which direction —
  and get only the steps that apply: [country-specific getting started
  guides](/getting-started) for [Belgium](/getting-started/belgium),
  [France](/getting-started/france), the
  [Netherlands](/getting-started/netherlands) and [every other supported
  country](/getting-started/other).
</Callout>
...
<Cards>
  <Card href="/getting-started" title="Country-Specific Getting Started">
    Tailored setup steps for Belgium, France, the Netherlands and beyond.
  </Card>
